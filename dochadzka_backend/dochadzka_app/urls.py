...
urlpatterns = [
    ...
    path('player/<int:playerid>/', get_player_by_id, name='get_player_by_id'),
    path('player/<int:playerid>/trainings/', get_trainings_by_player, name='get_trainings_by_player'),
